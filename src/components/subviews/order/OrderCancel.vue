  ...
  >
    <div class="relative p-4 w-full max-w-md max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        >
          <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Huỷ đơn món</h3>
          <button
            @click="closeModal"
            type="button"
        ...
        <div class="p-4 md:p-5 text-center">
          ...
          <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
            Bạn có chắc là muốn huỷ đơn món này không?
          </h3>
        </div>
        <!-- Modal footer -->
        <div
...
onMounted(() => {
  const $modalElement = document.querySelector('#cancelOrderModal')
  const modalOptions = {
    backdrop: 'static',
