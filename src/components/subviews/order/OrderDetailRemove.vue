        ...
        <div class="p-4 md:p-5 text-center">
          ...
          <div class="flex">
            <button
              @click="deleteDetail"
              type="button"
              class="text-white w-full justify-center bg-red-500 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center"
            >
              Có
            </button>
            <button
