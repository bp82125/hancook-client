<template>
  <div class="flex justify-start md:justify-end md:ms-3 shrink">
    <button
      id="sortOrderListButton"
      data-dropdown-toggle="sortOrderListRadio"
  ...
  <!-- Dropdown menu -->
  <div
    id="sortOrderListRadio"
    class="z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
  >
    <ul
      class="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200"
      aria-labelledby="sortOrderListButton"
    >
      <li>
        <div class="flex items-center">
          <input
            id="orderListDefaultRadio"
            type="radio"
            v-model="criteria"
            value="defaultValue"
            name="default-radio"
...
watchEffect(() => {
  orderListStore.sortOrders(criteria.value, mode.value)
})
</script>
