...
onMounted(() => {
  ...
  const $targetEl = document.getElementById('profitTimeRangeDropdown')
  const $triggerEl = document.getElementById('profitTimeRangeButton')
